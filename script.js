...
// Cache de elementos - inicialização segura
let elements = {};
...
function initElements() {
    try {
        elements = {
            ...
            trackCoverModal: document.getElementById('trackCoverModal'),
            trackCoverSongName: document.getElementById('trackCoverSongName'),
            trackCoverUpload: document.getElementById('trackCoverUpload'),
            musicWithCover: document.getElementById('musicWithCover'),
            musicCoverUpload: document.getElementById('musicCoverUpload')
        };
...
// Gerenciador de álbuns simplificado
...
function setupEventListeners() {
    ...
    if (elements.activeAlbumSelect) {
        elements.activeAlbumSelect.addEventListener('change', () => {
            // Implementação pode ser adicionada se necessário
        });
    }
    
    // Music cover checkbox
...
// Funções de upload simplificadas
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(initializeRadio, 100); // Pequeno delay para garantir que tudo esteja pronto
});
...
console.log('Script carregado com sucesso!');// Configuração da Cloudinary
const CLOUDINARY_CONFIG = {
    cloudName: 'dygbrcrr6',
    apiKey: '853591251513134',
    apiSecret: 'yVz8MbGa_undTqNHbOqzo-hKc-U',
